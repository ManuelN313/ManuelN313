...
Through the [FaMAF CVA6 Project](https://github.com/FaMAF-CVA6-Project), two browser-based pipeline visualisers for RISC-V cores:

- [MinorFlow](https://github.com/FaMAF-CVA6-Project/MinorFlow): reconstructs the gem5 MinorCPU pipeline, cycle by cycle, from gem5 debug traces.
- [CVA6Flow](https://github.com/FaMAF-CVA6-Project/CVA6Flow): the RTL sibling, for the CORE-V CVA6 core simulated in Verilator, straight off the VCD signals.
